 ...
 */
// first_layer                    0
// node                           <dory.Parsers.HW_node.HW_node object at 0x7fb1dfbbfa20>
// sdk                            gap_sdk
// number_of_clusters             1
// optional_type                  8bit
// func_name                      ReluPooling11
// flag_DW                        0
...
// x_tile_size_h                  25
// x_tile_size_w                  5
// x_tile_size_byte               34500
// x_tile_size_nif_byte           276
// x_stride_w_byte                1380
// x_stride_c_byte                276
// y_h                            1
// y_w                            1
// y_data_size_byte               8
...
// y_tile_size_h                  1
// y_tile_size_w                  1
// y_tile_size_byte               276
// y_stride_w_byte                276
// y_stride_c_byte                276
// y_tile_size_nof_byte           276
// tile_dim_h                     1
// tile_dim_w                     1
// tile_dim_nof                   1
// tile_dim_nif                   1
...
// l1_x_offset                    0
// l1_y_offset                    34508
// y_tile_size_nof_last           276
// y_tile_size_h_last             1
// y_tile_size_w_last             1
// y_length_nof_byte_last         276
// x_tile_size_nif_last           276
// x_tile_size_nif_byte_last      276
// x_tile_size_h_last             25
// x_tile_size_w_last             5


#include "ReluPooling11.h"
#include "pmsis.h"
#include "dory.h"
...
void ReluPooling11(
 ...
 uint8_t *im2col;
  ...
  for(iter=0; iter<1*1*1; iter++) {
    ...
    db_x = !db_state_x ? 34500 : 0;
    db_y = !db_state_y ? 276 : 0;
    exec_db_x = 0;
    ...
    y = (uint8_t *) (l1_buffer + 34508 + db_y);

    x_tile_size_nif_exec = (last_nif_exec) ? 276 : 276;
    x_tile_size_h_exec   = (last_h_exec)   ? 25 : 25;
    x_tile_size_w_exec   = (last_w_exec)   ? 5 : 5;

    y_tile_size_nof = (last_nof_exec) ? 276 : 276;
    ...
    y_length_nof_byte = (last_nof_exec)   ? 276 : 276;
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
...
// aggiungere padding su tutti i lati, acc_out, and filter asymettric
    ...
    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 1, 1, 276, 1, 276, 0, 0, 0, 0, 0, 0, 8);
    DMA_copy_y.loc = (l1_buffer + 34508) + db_y;
