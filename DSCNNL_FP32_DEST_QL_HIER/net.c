...
void net_step(void *args)
{
  ...
  if (op_mode == TRAIN){
    ...
    for (int epoch=0; epoch<1000; epoch++){
      ...
      gap_fc_starttimer();
      gap_fc_resethwtimer();
      start_cycles = gap_fc_readhwtimer();
      #endif
      ...
      printf ("Correct class: %i\n", classidx);
      #endif

      #ifdef MEASURE
      end_us = pi_time_get_us();
      end_cycles = gap_fc_readhwtimer();
      printf ("classifier_inference,%d,us,%d,cycles\n", end_us - start_us, end_cycles - start_cycles);
      #endif
      ...
      *loss_ptr = loss;
      ...
      end_us = pi_time_get_us();
      end_cycles = gap_fc_readhwtimer();
      printf ("update_weights,%d,us,%d,cycles\n", end_us - start_us, end_cycles - start_cycles);
      #endif
