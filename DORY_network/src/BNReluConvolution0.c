...
void BNReluConvolution0(
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 1)   ? 49 : 49;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 49, 10, 1, 10, 1,  8, 2,0, pad_offset_h, pad_offset_w, 0, 8);
    ...
    k = (int64_t *) (l1_buffer + 11074);
    lambda = (int64_t *) (l1_buffer + 11594);
    W = (uint8_t *) (l1_buffer + 8506);
    y = (uint8_t *) (l1_buffer + 498);
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
